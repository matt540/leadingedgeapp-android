...
import com.surfboardapp.Models.ProgressionLevel1
import com.surfboardapp.R

class ProgressionLevel1Adapter(
    val activity: MainActivity,
    private var progressionLevel1List: ArrayList<ProgressionLevel1>,
    private var statusType: String
) : RecyclerView.Adapter<ProgressionLevel1Adapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val progressionLevel1List: ProgressionLevel1 = progressionLevel1List[position]
        ...
        if (progressionLevel1List.status == "1") {
            ...
            holder.tvStatus.setTextColor(ContextCompat.getColor(context, R.color.color_red))
        } else if (progressionLevel1List.status == "3") {
